                                ...
                                function (resp) {
                                	if (resp.UserProfileItem && resp.UserProfileItem.length > 0) {
                                		if(resp.UserProfileItem[0].ProfileItem){
                                			sessionNick = resp.UserProfileItem[0].ProfileItem[0].Value;
                                		}else{
                                			sessionNick = resp.UserProfileItem[0].To_Account;
                                		}
                                		sessionId = resp.UserProfileItem[0].To_Account;
                                	}else{
                                		sessionNick = resp.UserProfileItem[0].To_Account;
                                		sessionId = resp.UserProfileItem[0].To_Account;
                                	}
                            		...
                            		if(sessionId==firstSessId){
                            			setSelSessStyleOn(sessionId);
                            		}
